from mc_python_flask.tutorialFUP.Repositorios.RepositorioMateria import RepositorioMateria
from mc_python_flask.tutorialFUP.Repositorios.RepositorioDepartamento import RepositorioDepartamento
